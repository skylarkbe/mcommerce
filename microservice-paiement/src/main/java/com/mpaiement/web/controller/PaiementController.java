...
public class PaiementController {
    ...
    public ResponseEntity<Paiement>  payerUneCommande(@RequestBody Paiement paiement){
        ...
        //on envoie l'objet commande mis à jour au microservice commande afin de mettre à jour le status de la commande.
        microserviceCommandeProxy.updateCommande(commande);

        //on renvoie 201 CREATED pour notifier le client au le paiement à été enregistré
